...
class PoDistributorsViewControllerExtended extends PoDistributorsViewController
{
    public function index()
    {
        ...
        return view("admin.po_distributors_view.index")->with(compact('menu','productsList','distributors','orderedQtyDistWise', 'orderedQtyPrdWise'));
    }
}
