...
Route::get('/inventorystocks/{id}/summary', [InventoryStock\InventorystockController::class, 'showSummary']);
...
Route::post('/inventorystocks/delete/{id}', [InventoryStock\InventorystockController::class, 'deletePo']);
