                    ...
                    <div class="left">
                        <form class="search-container js-ak-ajax-search" ><input name="categories_source" value="categories" type="hidden"/><input name="categories_length" value="{{Request()->query("categories_length")}}" type="hidden"/>
                            <div class="search">
                                ...
                                @if(Request()->query("sub_categories_source") == "sub_categories" && Request()->query("categories_search"))
            ...
            <div class="content table-content">
                ...
                <thead>
                    <tr data-sort-method='thead'>
                        ...
                        @canany(['sub_categories_edit','categories_delete'])
                ...
                @forelse($sub_categories_list_all as $data)
                    <tr>
                        ...
                        <td class="manage-td">
                           ...
                           <a href="{{ route('admin.sub_categories.edit', $data->id) }}" class="edit-link" draggable="false">
