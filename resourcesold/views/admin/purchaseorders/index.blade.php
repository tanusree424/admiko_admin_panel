	...
	<div class="content-layout content-width-full purchaseorders-data-content js-ak-DataTable js-ak-ajax-DataTable-container js-ak-content-layout"
        ...
        <div class="content-element">
			...
			<form method="GET" action="{{ route('admin.purchaseorders.index') }}">
				...
				@foreach($purchaseorders_list_all as $data)
    <tr>
        <td data-id="{{$data->id}}">
            {{$data->order_number}}
        </td>
...
<a href="#" data-id="{{$data->id}}" style="display:inline-block" data-userid="{{$data->admin_id}}"
                            class="view-order-summery" data-url="{{ route('admin.purchaseorders.index') }}" 
           ...
           <a href="#" class="btn btn-success btn-sm confirm-order-btn"
                data-id="{{ $data->id }}"
                data-url="{{ route('admin.purchaseorders.index') }}"    
            ...
            @if($data->admin_confirmed == 0)
                      <a href="#" data-id="{{$data->id}}" data-userid="{{$data->admin_id}}"
                            class="delete-po-order" data-url="{{ route('admin.purchaseorders.index') }}" 
