...
@canany(['admin_auditable_logs_access'])
	<div class="item{{ $menu['item'] === "admin_auditable_logs" ? " active" : "" }}">
		<a draggable="false" class="link" href="{{route("admin.admin_auditable_logs.index")}}">
			<div class="icon">
				<div class="font-awesome-icon">
			...
			<div class="title">Auditable logs</div>
		</a>
	</div>
@endcanany
@canany(['admin_users_access','admin_roles_access','admin_permissions_access','admin_teams_access'])
	<div class="dropdown js-ak-dropdown{{ $menu['folder'] == "admin_settings" ? " open" : "" }}">
		...
		<div class="dropdown-container" {!! $menu['folder'] == "admin_settings" ? ' style="display:block"' : '' !!}>
			<div class="dropdown-menu-list">
			@canany(['admin_users_access'])
				<div class="item{{ $menu['item'] === "admin_users" ? " active" : "" }}">
					<a draggable="false" class="link" href="{{route("admin.admin_users.index")}}">
						<div class="icon">
							<div class="font-awesome-icon">
			...
			@endcanany
			@canany(['admin_roles_access'])
				<div class="item{{ $menu['item'] === "admin_roles" ? " active" : "" }}">
					<a draggable="false" class="link" href="{{route("admin.admin_roles.index")}}">
						<div class="icon">
							<div class="font-awesome-icon">
			...
			@endcanany
			@canany(['admin_permissions_access'])
				<div class="item{{ $menu['item'] === "admin_permissions" ? " active" : "" }}">
					<a draggable="false" class="link" href="{{route("admin.admin_permissions.index")}}">
						<div class="icon">
							<div class="font-awesome-icon">
			...
			@endcanany
			@canany(['admin_teams_access'])
				<div class="item{{ $menu['item'] === "admin_teams" ? " active" : "" }}">
					<a draggable="false" class="link" href="{{route("admin.admin_teams.index")}}">
						<div class="icon">
							<div class="font-awesome-icon">
...
@endcanany
@canany(['brands_access'])
	<div class="item{{ $menu['item'] === "brands" ? " active" : "" }}">
		<a draggable="false" class="link" href="{{route("admin.brands.index")}}">
			<div class="icon">
				<div class="font-awesome-icon">
...
@endcanany
{{-- @canany(['sub_categories_access'])
	<div class="item{{ $menu['item'] === "sub_categories" ? " active" : "" }}">
...
<div class="dropdown-container" {!! $menu['folder'] == "sub_categories" ? ' style="display:block"' : '' !!}>
			...
			@canany(['admin_users_access'])
				<div class="item{{ $menu['item'] === "admin_users" ? " active" : "" }}">
					<a draggable="false" class="link" href="{{route("admin.sub_categories.index")}}">
						<div class="icon">
							<div class="font-awesome-icon">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M144 0a80 80 0 1 1 0 160A80 80 0 1 1 144 0zM512 0a80 80 0 1 1 0 160A80 80 0 1 1 512 0zM0 298.7C0 239.8 47.8 192 106.7 192h42.7c15.9 0 31 3.5 44.6 9.7c-1.3 7.2-1.9 14.7-1.9 22.3c0 38.2 16.8 72.5 43.3 96c-.2 0-.4 0-.7 0H21.3C9.6 320 0 310.4 0 298.7zM405.3 320c-.2 0-.4 0-.7 0c26.6-23.5 43.3-57.8 43.3-96c0-7.6-.7-15-1.9-22.3c13.6-6.3 28.7-9.7 44.6-9.7h42.7C592.2 192 640 239.8 640 298.7c0 11.8-9.6 21.3-21.3 21.3H405.3zM224 224a96 96 0 1 1 192 0 96 96 0 1 1 -192 0zM128 485.3C128 411.7 187.7 352 261.3 352H378.7C452.3 352 512 411.7 512 485.3c0 14.7-11.9 26.7-26.7 26.7H154.7c-14.7 0-26.7-11.9-26.7-26.7z"/></svg>
							</div>
...
@endcanany
@canany(['countries_access'])
	<div class="item{{ $menu['item'] === "countries" ? " active" : "" }}">
		<a draggable="false" class="link" href="{{route("admin.countries.index")}}">
			<div class="icon">
				<div class="font-awesome-icon">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M64 464c-8.8 0-16-7.2-16-16V64c0-8.8 7.2-16 16-16H224v80c0 17.7 14.3 32 32 32h80V448c0 8.8-7.2 16-16 16H64zM64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V154.5c0-17-6.7-33.3-18.7-45.3L274.7 18.7C262.7 6.7 246.5 0 229.5 0H64zm56 256c-13.3 0-24 10.7-24 24s10.7 24 24 24H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H120zm0 96c-13.3 0-24 10.7-24 24s10.7 24 24 24H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H120z"/></svg>
				</div>
...
@endcanany
@canany(['product_stock_a_access'])
	<!--<div class="item{{ $menu['item'] === "product_stock_a" ? " active" : "" }}">
		<a draggable="false" class="link" href="{{route("admin.product_stock_a.index")}}">
			<div class="icon">
				<div class="font-awesome-icon">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M64 464c-8.8 0-16-7.2-16-16V64c0-8.8 7.2-16 16-16H224v80c0 17.7 14.3 32 32 32h80V448c0 8.8-7.2 16-16 16H64zM64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V154.5c0-17-6.7-33.3-18.7-45.3L274.7 18.7C262.7 6.7 246.5 0 229.5 0H64zm56 256c-13.3 0-24 10.7-24 24s10.7 24 24 24H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H120zm0 96c-13.3 0-24 10.7-24 24s10.7 24 24 24H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H120z"/></svg>
				</div>
...
@endcanany
@canany(['product_country_mapping_access'])
	<div class="item{{ $menu['item'] === "product_country_mapping" ? " active" : "" }}">
		<a draggable="false" class="link" href="{{route("admin.product_country_mapping.index")}}">
			<div class="icon">
				<div class="font-awesome-icon">
			...
			<div class="title">Product Country Mapping</div>
		</a>
	</div>
@endcanany
@canany(['productstocklogs_access'])
	<div class="item{{ $menu['item'] === "productstocklogs" ? " active" : "" }}">
		<a draggable="false" class="link" href="{{route("admin.productstocklogs.index")}}">
			<div class="icon">
				<div class="font-awesome-icon">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M64 464c-8.8 0-16-7.2-16-16V64c0-8.8 7.2-16 16-16H224v80c0 17.7 14.3 32 32 32h80V448c0 8.8-7.2 16-16 16H64zM64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V154.5c0-17-6.7-33.3-18.7-45.3L274.7 18.7C262.7 6.7 246.5 0 229.5 0H64zm56 256c-13.3 0-24 10.7-24 24s10.7 24 24 24H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H120zm0 96c-13.3 0-24 10.7-24 24s10.7 24 24 24H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H120z"/></svg>
				</div>
			</div>
			<div class="title">ProductStockLogs</div>
		</a>
	</div>
@endcanany
@canany(['purchaseorders_access'])
	<div class="item{{ $menu['item'] === "purchaseorders" ? " active" : "" }}">
		<a draggable="false" class="link" href="{{route("admin.purchaseorders.index")}}">
			<div class="icon">
				<div class="font-awesome-icon">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M64 464c-8.8 0-16-7.2-16-16V64c0-8.8 7.2-16 16-16H224v80c0 17.7 14.3 32 32 32h80V448c0 8.8-7.2 16-16 16H64zM64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V154.5c0-17-6.7-33.3-18.7-45.3L274.7 18.7C262.7 6.7 246.5 0 229.5 0H64zm56 256c-13.3 0-24 10.7-24 24s10.7 24 24 24H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H120zm0 96c-13.3 0-24 10.7-24 24s10.7 24 24 24H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H120z"/></svg>
				</div>
...
@canany(['purchaseorderslogs_access'])
	<div class="item{{ $menu['item'] === "purchaseorderslogs" ? " active" : "" }}">
		<a draggable="false" class="link" href="{{route("admin.purchaseorderslogs.index")}}">
			...
			<div class="title">PurchaseOrdersLogs</div>
		</a>
	</div>
@endcanany
@canany(['salesreports_access'])
	<div class="item{{ $menu['item'] === "salesreports" ? " active" : "" }}">
		<a draggable="false" class="link" href="{{route("admin.salesreports.index")}}">
			<div class="icon">
				<div class="font-awesome-icon">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M64 464c-8.8 0-16-7.2-16-16V64c0-8.8 7.2-16 16-16H224v80c0 17.7 14.3 32 32 32h80V448c0 8.8-7.2 16-16 16H64zM64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V154.5c0-17-6.7-33.3-18.7-45.3L274.7 18.7C262.7 6.7 246.5 0 229.5 0H64zm56 256c-13.3 0-24 10.7-24 24s10.7 24 24 24H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H120zm0 96c-13.3 0-24 10.7-24 24s10.7 24 24 24H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H120z"/></svg>
				</div>
			</div>
			<div class="title">SalesReports</div>
		</a>
	</div>
@endcanany
@canany(['stockreports_access'])
	<div class="item{{ $menu['item'] === "stockreports" ? " active" : "" }}">
		<a draggable="false" class="link" href="{{route("admin.stockreports.index")}}">
			<div class="icon">
				<div class="font-awesome-icon">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M64 464c-8.8 0-16-7.2-16-16V64c0-8.8 7.2-16 16-16H224v80c0 17.7 14.3 32 32 32h80V448c0 8.8-7.2 16-16 16H64zM64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V154.5c0-17-6.7-33.3-18.7-45.3L274.7 18.7C262.7 6.7 246.5 0 229.5 0H64zm56 256c-13.3 0-24 10.7-24 24s10.7 24 24 24H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H120zm0 96c-13.3 0-24 10.7-24 24s10.7 24 24 24H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H120z"/></svg>
				</div>
			</div>
			<div class="title">StockReports</div>
		</a>
	</div>
@endcanany
@canany(['userloginsession_access'])
	<div class="item{{ $menu['item'] === "userloginsession" ? " active" : "" }}">
		<a draggable="false" class="link" href="{{route("admin.userloginsession.index")}}">
			<div class="icon">
				<div class="font-awesome-icon">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M64 464c-8.8 0-16-7.2-16-16V64c0-8.8 7.2-16 16-16H224v80c0 17.7 14.3 32 32 32h80V448c0 8.8-7.2 16-16 16H64zM64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V154.5c0-17-6.7-33.3-18.7-45.3L274.7 18.7C262.7 6.7 246.5 0 229.5 0H64zm56 256c-13.3 0-24 10.7-24 24s10.7 24 24 24H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H120zm0 96c-13.3 0-24 10.7-24 24s10.7 24 24 24H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H120z"/></svg>
				</div>
			</div>
			<div class="title">UserLoginSession</div>
		</a>
	</div>
@endcanany
@canany(['users_access'])
	<div class="item{{ $menu['item'] === "users" ? " active" : "" }}">
		<a draggable="false" class="link" href="{{route("admin.users.index")}}">
			<div class="icon">
				<div class="font-awesome-icon">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M64 464c-8.8 0-16-7.2-16-16V64c0-8.8 7.2-16 16-16H224v80c0 17.7 14.3 32 32 32h80V448c0 8.8-7.2 16-16 16H64zM64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V154.5c0-17-6.7-33.3-18.7-45.3L274.7 18.7C262.7 6.7 246.5 0 229.5 0H64zm56 256c-13.3 0-24 10.7-24 24s10.7 24 24 24H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H120zm0 96c-13.3 0-24 10.7-24 24s10.7 24 24 24H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H120z"/></svg>
				</div>
...
@endcanany
@canany(['po_upload_access','upload_sales_report_access','upload_stock_report_access','stock_report_upload_access'])
	<div class="dropdown js-ak-dropdown{{ $menu['folder'] == "excelreport_uploads" ? " open" : "" }}">
		<div class="dropdown-item js-ak-dropdown-item">
			<div class="item">
				<a draggable="false" class="link" href="">
					<div class="icon">
					...
					<div class="title">Excel/Report Uploads</div>
					<div class="icon action-icon">
						<div class="font-awesome-icon">
							<svg focusable="false" data-prefix="fas" data-icon="angle-right" class="svg-inline--fa fa-angle-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512">
								<path fill="currentColor" d="M64 448c-8.188 0-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L178.8 256L41.38 118.6c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l160 160c12.5 12.5 12.5 32.75 0 45.25l-160 160C80.38 444.9 72.19 448 64 448z"></path>
		...
		<div class="dropdown-container" {!! $menu['folder'] == "excelreport_uploads" ? ' style="display:block"' : '' !!}>
			<div class="dropdown-menu-list">
			@canany(['po_upload_access'])
				<div class="item{{ $menu['item'] === "po_upload" ? " active" : "" }}">
					<a draggable="false" class="link" href="{{route("admin.po_upload.index")}}">
						<div class="icon">
							<div class="font-awesome-icon">
			...
			@endcanany
			@canany(['upload_sales_report_access'])
				<div class="item{{ $menu['item'] === "upload_sales_report" ? " active" : "" }}">
					<a draggable="false" class="link" href="{{route("admin.upload_sales_report.index")}}">
						<div class="icon">
							<div class="font-awesome-icon">
						...
						<div class="title">Upload Sales Report</div>
					</a>
				</div>
			@endcanany
			<!-- @canany(['upload_stock_report_access'])
				<div class="item{{ $menu['item'] === "upload_stock_report" ? " active" : "" }}">
					<a draggable="false" class="link" href="{{route("admin.upload_stock_report.index")}}">
						<div class="icon">
							<div class="font-awesome-icon">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V160H256c-17.7 0-32-14.3-32-32V0H64zM256 0V128H384L256 0zM155.7 250.2L192 302.1l36.3-51.9c7.6-10.9 22.6-13.5 33.4-5.9s13.5 22.6 5.9 33.4L221.3 344l46.4 66.2c7.6 10.9 5 25.8-5.9 33.4s-25.8 5-33.4-5.9L192 385.8l-36.3 51.9c-7.6 10.9-22.6 13.5-33.4 5.9s-13.5-22.6-5.9-33.4L162.7 344l-46.4-66.2c-7.6-10.9-5-25.8 5.9-33.4s25.8-5 33.4 5.9z"/></svg>
							</div>
						</div>
						<div class="title">Upload Stock Report</div>
					</a>
				</div>
			@endcanany -->
			@canany(['stock_report_upload_access'])
				<div class="item{{ $menu['item'] === "stock_report_upload" ? " active" : "" }}">
					<a draggable="false" class="link" href="{{route("admin.stock_report_upload.index")}}">
						<div class="icon">
							<div class="font-awesome-icon">
								<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M48 448V64c0-8.8 7.2-16 16-16H224v80c0 17.7 14.3 32 32 32h80V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16zM64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V154.5c0-17-6.7-33.3-18.7-45.3L274.7 18.7C262.7 6.7 246.5 0 229.5 0H64zm90.9 233.3c-8.1-10.5-23.2-12.3-33.7-4.2s-12.3 23.2-4.2 33.7L161.6 320l-44.5 57.3c-8.1 10.5-6.3 25.5 4.2 33.7s25.5 6.3 33.7-4.2L192 359.1l37.1 47.6c8.1 10.5 23.2 12.3 33.7 4.2s12.3-23.2 4.2-33.7L222.4 320l44.5-57.3c8.1-10.5 6.3-25.5-4.2-33.7s-25.5-6.3-33.7 4.2L192 280.9l-37.1-47.6z"/></svg>
							</div>
						</div>
						<div class="title">Stock Report Upload</div>
					</a>
				</div>
			@endcanany
			</div>
...
@endcanany
@canany(['po_distributors_view_access','po_distributors_view.purchase_orders_access'])
	<div class="item{{ $menu['item'] === "po_distributors_view" ? " active" : "" }}">
		<a draggable="false" class="link" href="{{route("admin.po_distributors_view")}}">
			<div class="icon">
				<div class="font-awesome-icon">
			...
			<div class="title">PO Distributors View</div>
		</a>
	</div>

	<div class="item{{ $menu['item'] === "stock_distributors_view" ? " active" : "" }}">
		<a draggable="false" class="link" href="{{route("admin.stock_distributors_view")}}">
			<div class="icon">
				<div class="font-awesome-icon">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M290.8 48.6l78.4 29.7L288 109.5 206.8 78.3l78.4-29.7c1.8-.7 3.8-.7 5.7 0zM136 92.5V204.7c-1.3 .4-2.6 .8-3.9 1.3l-96 36.4C14.4 250.6 0 271.5 0 294.7V413.9c0 22.2 13.1 42.3 33.5 51.3l96 42.2c14.4 6.3 30.7 6.3 45.1 0L288 457.5l113.5 49.9c14.4 6.3 30.7 6.3 45.1 0l96-42.2c20.3-8.9 33.5-29.1 33.5-51.3V294.7c0-23.3-14.4-44.1-36.1-52.4l-96-36.4c-1.3-.5-2.6-.9-3.9-1.3V92.5c0-23.3-14.4-44.1-36.1-52.4l-96-36.4c-12.8-4.8-26.9-4.8-39.7 0l-96 36.4C150.4 48.4 136 69.3 136 92.5zM392 210.6l-82.4 31.2V152.6L392 121v89.6zM154.8 250.9l78.4 29.7L152 311.7 70.8 280.6l78.4-29.7c1.8-.7 3.8-.7 5.7 0zm18.8 204.4V354.8L256 323.2v95.9l-82.4 36.2zM421.2 250.9c1.8-.7 3.8-.7 5.7 0l78.4 29.7L424 311.7l-81.2-31.1 78.4-29.7zM523.2 421.2l-77.6 34.1V354.8L528 323.2v90.7c0 3.2-1.9 6-4.8 7.3z"/></svg>
				</div>
			</div>
			<div class="title">Stock Distributors View</div>
		</a>
	</div>
@endcanany
