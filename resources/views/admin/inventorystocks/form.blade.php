...
@section('breadcrumbs')
	<li class="breadcrumb-item"><a href="{{ route("admin.purchaseorders.index") }}"> Inventory Stocks</a></li>
    @if(isset($data->id))
...
@section('page-back-button'){{ route("admin.inventorystock.index") }}@endsection
@section('page-content')
<div class="form-container content-width-medium purchaseorders-form-content js-ak-delete-container" data-delete-modal-action="{{route("admin.inventorystock.delete")}}">
    <form method="POST" action="@isset($data->id){{route("admin.inventorystock.update", $data->id)}}@else{{route("admin.inventorystock.store")}}@endisset" enctype="multipart/form-data" class="form-page validate-form" novalidate>
        <div hidden>
                    ...
                    <div class="input-container">
                        ...
                        <div class="input-data">
                            <input type="text" class="form-input" id="orderqty" autocomplete="off"
                                   name="order_qty" required placeholder="orderQty"
