...
<div class="page-content-width-full">
	...
	<div class="content-layout content-width-full users-data-content js-ak-DataTable js-ak-ajax-DataTable-container js-ak-content-layout"
        data-id="users"
		data-ajax-call-url="{{route("admin.users.index")}}"
        data-delete-modal-action="{{route("admin.users.delete")}}">
        <div class="content-element">
            <div class="content-header">
                ...
                <div class="action">
                    <div class="left">
                        <form class="search-container js-ak-ajax-search" ><input name="users_source" value="users" type="hidden"/><input name="users_length" value="{{Request()->query("users_length")}}" type="hidden"/>
                            <div class="search">
                                <input type="text" autocomplete="off" placeholder="{{trans('admin/table.search')}}" name="users_search" value="{{(Request()->query("users_source") == "users")?Request()->query("users_search")??"":""}}" class="form-input js-ak-search-input">
                                <button class="search-button" draggable="false">
                                    @includeIf("admin/admin_layout/partials/misc/icons/search_icon")
                                </button>
                                @if(Request()->query("users_source") == "users" && Request()->query("users_search"))
                    ...
                    <div class="right">
                        @canany('users_create')
                        <a href="{{route('admin.users.create')}}" class="button primary-button add-new" draggable="false">
