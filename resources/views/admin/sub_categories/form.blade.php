...
@section('breadcrumbs')
	<li class="breadcrumb-item"><a href="{{ route("admin.sub_categories.index") }}">Category</a></li>
    @if(isset($data->id))
...
<div class="form-container content-width-medium sub-categories-form-content js-ak-delete-container" data-delete-modal-action="{{route("admin.sub_categories.delete")}}">
