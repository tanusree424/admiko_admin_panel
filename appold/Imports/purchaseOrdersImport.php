...
class purchaseOrdersImport implements ToModel, WithHeadingRow ,WithValidation
{
    /**
    * @param array $row
    *
    ...
    */
    ...
    $requiredFields = ['part_code', 'order_qty', 'billing_price'];
    ...
    foreach ($requiredFields as $field) {
        ...
        return new Purchaseorderspreview([
