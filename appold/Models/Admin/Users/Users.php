...
class Users extends Model
{
    ...
    {
        if ($request->has('users_sort_by') && $request->users_sort_by) {
            if($request->users_direction == "desc"){
                $query->orderByDesc($request->users_sort_by);
            } else {
                $query->orderBy($request->users_sort_by);
            }
        } else {
