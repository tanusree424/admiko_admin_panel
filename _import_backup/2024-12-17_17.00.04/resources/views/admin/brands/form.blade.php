                ...
                <div class="row-100 el-box-text">
                    <div class="input-container">
                        ...
                        <div class="input-data">
                            <input type="text" class="form-input" id="brandid" autocomplete="off"
                                   name="brandid"  placeholder="brandId"
                                   value="{{{ old('brandid', $data->brandid??'') }}}">
                            <div class="error-message @if ($errors->has('brandid')) show @endif">{{trans('admin/form.required_text')}}</div>
                            <div class="text-muted" id="brandid_help"></div>
                        </div>
                    </div>
                </div>
                <div class="row-100 el-box-text">
