...
class Brands extends Model
{
    ...
    {
        if ($request->has('brands_sort_by') && $request->brands_sort_by) {
            if($request->brands_direction == "desc"){
                $query->orderByDesc($request->brands_sort_by);
            } else {
                $query->orderBy($request->brands_sort_by);
            }
        } else {
